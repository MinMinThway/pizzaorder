  	...
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a href="{{route('orderhistorypage')}}" class="ml-4 text-dark">History</a>
                                </div>
            ...
            <li class="nav-item"><a href="{{route('shopping')}}" class="nav-link"><i class="fas fa-shopping-cart fa-2x" id="cartNoti"></i></a></li>
            <li class="nav-item"><a href="{{route('shopping')}}" class="nav-link" id="showPrice"> KS</a></li>
            <li class="nav-item"><a href="{{route('shopping')}}" class="nav-link">Shopping</a></li>
	        </ul>
	      </div>
		  </div>
	  </nav>
     <section class="home-slider owl-carousel img" style="background-image: url({{'frontend_assets/images/bg_1.jpg'}});">
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 ftco-animate">
              <img src="{{asset('frontend_assets/images/bg_1.png')}}" class="img-fluid" alt="">
            </div>
      ...
      <div class="slider-item">
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 ftco-animate">
              <img src="{{asset('frontend_assets/images/bg_2.png')}}" class="img-fluid" alt="">
            </div>
      ...
      <div class="slider-item" style="background-image: url({{asset('frontend_assets/images/bg_3.jpg')}});">
        <div class="overlay"></div>
        <div class="container">
          ...
          <div class="col-lg-4 col-md-6 mb-5 mb-md-5">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url({{'frontend_assets/images/image_1.jpg'}});"></a>
                <div class="text">
          ...
          <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">34 West 21th Street,Hladen 721 Yangon 10016</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">0978956632</span></a></li>
...
{{-- add to cart --}}
  {{-- <script src="{{asset('frontend_assets/js/add.js')}}"></script> --}}
{{-- add to cart --}}
