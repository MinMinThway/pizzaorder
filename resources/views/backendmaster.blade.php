...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item  {{ request()->is('backend.dashboard') ? 'active' : '' }}" href="{{'backend.dashboard'}}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>
   ...
   @yield('content')
    ...
    <!-- The javascript plugin to display page loading on top-->s
